...
const lexer_1 = require("../../compiler/src/lexer");
const parser_1 = require("../../compiler/src/parser");
const parser_base_1 = require("../../compiler/src/parser_base");
const typechecker_1 = require("../../compiler/src/typechecker");
...
function validateAndExtract(doc) {
    ...
    let tokens;
    try {
        tokens = new lexer_1.Lexer(text).tokenize();
    }
    catch (e) {
