...
exports.emitTestSuite = void 0;
function toSnakeCase(s) {
    return s.replace(/([a-z])([A-Z])/g, "$1_$2").toLowerCase();
}
function emitTestSuite(system) {
    const lines = [];
    ...
    for (const mod of system.modules) {
        ...
        lines.push(``);
        // Create test
        const createFields = model.fields.filter(f => !["id", "created_at", "updated_at"].includes(f.name));
...
exports.emitTestSuite = emitTestSuite;
...
//# sourceMappingURL=emit_tests.js.map