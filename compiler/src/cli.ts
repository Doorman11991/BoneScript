...
function showHelp() {
  ...
  console.log("");
  console.log("Usage:");
  console.log("  bone compile <file>   Compile to runnable project");
  console.log("  bone check <file>     Lex + parse + type check (no codegen)");
  console.log("  bone lex <file>       Show token stream");
  console.log("  bone parse <file>     Show AST");
  console.log("  bone ir <file>        Show IR (JSON)");
  console.log("  bone fmt <file>       Format file in place");
  console.log("  bone watch <file>     Recompile on change");
  console.log("  bone diff <old.bone> <new.bone>  Show schema migration diff");
  console.log("");
